...
const Sidebar = () => {
	...
	return (
		<div className="space-y-2 min-w-max max-w-lg">
			{/* Top */}
			<div className="bg-white dark:bg-[#1d2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border-gray-300 dark:border-none">
				<div className="relative w-full h-14">
					<Image src="https://rb.gy/i26zak" fill priority alt="avatar" />
				</div>
				<Avatar
					onClick={signOut}
			...
			{/* Bottom */}
			<div className="hidden md:flex bg-white dark:bg-[#1d2226] text-black/70 dark:text-white overflow-hidden flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none px-3">
